...
export default function PractiseLion() {
    ...
    const [cat, setCat] = useState(LionPoses);
    ...
    async function onResults(results) {
        ...
        if (results.multiHandLandmarks) {
            ...
            if (totalLandmarks.length === 63) {
                ...
                if (result.data.probability > 0.7 && currentStep < 2 && result.data.predict === 'lion-pose-1') {
                    setCurrentStep(2);
                    setFinish(true);
                    stopDetection();
                ...
                <Col span={8} align="center" justify="center">
                    ...
                    {result && currentStep < 2 && (
                        <div>
                            ...
                            <h4>Probability : {landmarkClass === cat[currentPose].name ? probability.toFixed(2) : 0}</h4>
                        </div>
                    )}
                    {/* show class and probability */}
