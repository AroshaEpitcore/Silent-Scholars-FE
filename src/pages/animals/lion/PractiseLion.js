    ...
    async function onResults(results) {
        ...
        if (results.multiHandLandmarks) {
            ...
            if (totalLandmarks.length === 63) {
                ...
                if (result.data.probability > 0.7 && currentStep < DONE_STEP && result.data.predict === "lion-pose-1") {
            ...
            <div className="an-container">
                ...
                <div className="an-practice-grid">
                    <div className="an-card">
                        <div className="an-card-header"><FaCrown /> {t("referencePose")}</div>
                                ...
                                <div className="an-status-panel">
                                    <div className="an-detecting" style={{ width: "100%" }}>
                                        ...
                                        <div className="an-prob-track">
                                            <div className={`an-prob-fill ${probPct >= 70 ? "good" : ""}`} style={{ width: `${probPct}%` }} />
                                        </div>
